    ...
    if (autoIDFlag === 'true') {
      return new Promise(resolve => {
        db.collection(collectionName)
          .add(data)
          .then((ref) => {
            console.log(`${doc} (${ref.id}) is created successfully to firestore!`);
            resolve('Data wrote!');
          })
          .catch(error => {
            console.log(error);
